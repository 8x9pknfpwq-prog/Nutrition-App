          ...
          <ThemedView style={styles.section}>
            ...
            <ThemedView style={styles.infoBox}>
              <ThemedText type="small" style={styles.stepText}>
                <ThemedText type="code">1.</ThemedText> Browse bars and clubs
              </ThemedText>
              <ThemedText type="small" style={styles.stepText}>
                <ThemedText type="code">2.</ThemedText> Tap a venue to see details
              </ThemedText>
              <ThemedText type="small" style={styles.stepText}>
                <ThemedText type="code">3.</ThemedText> Submit your wait time estimate
              </ThemedText>
              <ThemedText type="small" style={styles.stepText}>
                <ThemedText type="code">4.</ThemedText> Help others make informed decisions
              </ThemedText>
            </ThemedView>
          </ThemedView>
        </ScrollView>
