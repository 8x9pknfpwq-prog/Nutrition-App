...
OUT = "/tmp/claude-0/-home-user-Nutrition-App/0719ad5f-7ab1-5efe-9e30-7dbbaba90dcd/scratchpad/shots_ipad"
...
.phone {{
  margin-top:70px; width:1120px; border-radius:62px; overflow:hidden;
